...
console.log(
  `Car 33 is a ${inventory[32].car_make} ${inventory[32].car_modeld} ${inverntory[32].car_make}${inventory[32].car_make}`
);
...
for (let i = inventory.length - i; i > 0; i--) {
...
//   if (carModels.car_make === 'Audi' || car.car_make ==='BMW')
//   return JSON.stringify(car);
// });

// console.log(BMWAndAudiFiltered);
